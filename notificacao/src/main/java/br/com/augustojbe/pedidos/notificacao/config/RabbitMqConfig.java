package br.com.augustojbe.pedidos.notificacao.config;
...
public class RabbitMqConfig {
    ...
    @Bean
    public FanoutExchange pedidosExchenge(){
    ...
    // recuperar msg perdidas no rabbitmq
    @Bean
    public FanoutExchange pedidosDlxExchenge(){
    ...
    public Binding binding(){
        return BindingBuilder.bind(notificacaoQueue()).to(pedidosExchenge());
    }

    @Bean
    public Binding bindingDlq(){
        return BindingBuilder.bind(notificacaoDlqQueue()).to(pedidosDlxExchenge());
    }
